          ...
          <div class="col-md-12">          
            <div class="panel-body">
               <h2>Blood Stock</h2>
                ...
                <form method="post" action="blood-quantity.php" class="form-horizontal" enctype="multipart/form-data">
                  <button name="view" type="submit">View Blood sctock Count</button>
                  </form>

                  <div class="search-text">
                    <input type="text" id="bg" onkeyup="myFunction()" placeholder="Search Blood Group">
                    <input type="text" id="district" onkeyup="myFunction1()" placeholder="Search by Code">
                  </div>
<?php if($error){?>
...
$sql  = mysqli_query($dbh, "SELECT * from  bloodstock ");
