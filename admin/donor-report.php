        ...
        <div class="row">
          ...
          <div class="col-md-12">          
            <div class="panel-body">
               <h2>Donor Report</h2>
               <input type="button"  value="Print" onclick="printPage()" style="padding: 9px 20px;" />
...
if(isset($_POST['view']))
  ...
  $sql  = mysqli_query($dbh, "SELECT province,bloodgroup,count(*) from  donors group by bloodgroup,province ORDER BY COUNT(*) ");
