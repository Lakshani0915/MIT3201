        ...
        <div class="row">
          ...
          <div class="col-md-6">          
            <div class="panel-body">
               ...
               <input type="button"  value="Print" onclick="printPage()" style="padding: 9px 20px; float: left;" />
...
if(isset($_POST['view']))
  ...
  $sql  = mysqli_query($dbh, "SELECT bloodgroup,count(*) from  bloodstock group by bloodgroup ORDER BY COUNT(*) ");
