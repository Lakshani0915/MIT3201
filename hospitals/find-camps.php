        ...
        <div class="row">
          ...
          <div class="col-md-12">          
            <div class="panel-body">
               <h2>Find Donation Camps</h2>

                  <div class="search-text">
                    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Find for Date.." title="Type in a date">
                    <input type="text" id="searchtype" onkeyup="myFunction1()" placeholder="Search for District.." title="Type in a district">
                  </div>
<?php if($error){?>
...
$sql  = mysqli_query($dbh, "SELECT * from  postcamp ");
